 ...
 */
        ...
        findViewById<TextView>(R.id.cpu_label).text= "Hisilicon Kirin 659"
        findViewById<TextView>(R.id.memory_label).text= "Memory: 4GB , 933 MHz"
    ...
    fun cpuName(): String?{
        var CPU_NAME=""
            try {
                val bufferedReader = BufferedReader(FileReader("/proc/cpuinfo"), 8192)
